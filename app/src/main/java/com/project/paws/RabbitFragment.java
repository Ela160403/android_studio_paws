...
public class RabbitFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // Populate Spinners
        ArrayAdapter<CharSequence> breedAdapter = ArrayAdapter.createFromResource(getContext(), R.array.rabbit_breed_array, android.R.layout.simple_spinner_item);
    ...
    private void clearFields() {
        ...
        imagePreview.setImageResource(R.drawable.rabit); // Change to default rabbit image if available
        imageUri = null;
    }
}
