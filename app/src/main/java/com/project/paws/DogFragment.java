...
public class DogFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // Populate Spinners
        ArrayAdapter<CharSequence> breedAdapter = ArrayAdapter.createFromResource(getContext(), R.array.dog_breed_array, android.R.layout.simple_spinner_item);
    ...
    private void saveDogDetails() {
        ...
        dogDetails.put("breed", breed);
        dogDetails.put("height", height);
        dogDetails.put("weight", weight);
        dogDetails.put("age", age);
        dogDetails.put("color", color);
        dogDetails.put("petName", petName);
        dogDetails.put("vaccination", vaccination);
        dogDetails.put("dosages", dosages);
        if (imageUri != null) {
            dogDetails.put("imageUri", imageUri.toString());
        }
                ...
                .addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentReference> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(getActivity(), "Dog details saved", Toast.LENGTH_SHORT).show();
                            clearFields();
                        } else {
                            Toast.makeText(getActivity(), "Error saving dog details", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
    ...
    private void clearFields() {
        ...
        imagePreview.setImageResource(R.drawable.ddog);
        imageUri = null;
    }
}
